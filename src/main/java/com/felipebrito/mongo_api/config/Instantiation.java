...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, Instant.now(), "Partiu viagem!", "Vou viajar para o Rio de Janeiro, abraços", maria);
        Post post2 = new Post(null, Instant.now(), "Boa noite!", "Desejo a todos uma boa noite", maria);
